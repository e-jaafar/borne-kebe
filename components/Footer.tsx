          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <Link 
                  href={`/${lang}/privacy`}
                  className="relative text-gray-600 dark:text-gray-400 hover:text-purple-600 dark:hover:text-purple-400 transition-colors"
                >
                  {t.legal.privacy.title}
                  <motion.span
                    className="absolute left-0 -bottom-1 w-full h-0.5 bg-purple-600 dark:bg-purple-400"
                    initial={{ width: 0 }}
          ...
          <div className="flex flex-col md:flex-row justify-between items-center gap-4 text-sm text-gray-600 dark:text-gray-400 mb-16 md:mb-0">
            ...
            <div className="flex items-center space-x-1">
              ...
              <motion.div
                ...
                transition={!prefersReducedMotion ? transitionSettings : {}}
