export const translations = {
  fr: {
    ...
    features: {
      ...
      subtitle: "Des fonctionnalités innovantes pour une expérience unique",
  ...
  nl: {
    ...
    form: {
      ...
      success: "Uw bericht is verzonden, ons team zal zo spoedig mogelijk contact met u opnemen.",
